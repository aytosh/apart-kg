...
router.post(
  ...
  body("budgetMin").isInt({ min: 0, max: 10000000 }),
  body("budgetMax").isInt({ min: 0, max: 10000000 }),
  body("bio").isString().isLength({ min: 5, max: 1000 }),
  body("lifestyleTags").isArray({ max: 24 }),
